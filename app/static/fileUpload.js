...
App.init = function () {
	...
	function handleFileSelect(evt) {
		...
		var template = "" + Object.keys(files).map(function (file) {
		    ...
		    var cancel_button = "<div class=\"cancel anim\">\n\t<svg onclick=\"location.reload();\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 1000 1000\">\n\t\t<g><path id=\"path2\" d=\"M500,10C229.4,10,10,229.4,10,500c0,270.6,219.4,490,490,490c270.6,0,490-219.4,490-490C990,229.4,770.6,10,500,10z M500,967.7C241.7,967.7,32.3,758.3,32.3,500C32.3,241.7,241.7,32.3,500,32.3c258.3,0,467.7,209.4,467.7,467.7C967.7,758.3,758.3,967.7,500,967.7z M348.4,325L648,623.1L669,625.1z M648.4,325L348,623.1L364,625.1z\"</g>\n\t\t</svg>\n\t\t\t\t\t\t</a>\n</div>";

		    var name_section = "<div class=\"name\" style=\"width: ";
		    name_section += name_section_width + "px;\">" + cancel_button;
